        ...
        <form method="POST" action="{{ route("admin.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('entering') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="entering" id="entering" value="1" {{ $employee->entering || old('entering', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('shipping') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="shipping" id="shipping" value="1" {{ $employee->shipping || old('shipping', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('quoting') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="quoting" id="quoting" value="1" {{ $employee->quoting || old('quoting', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pricing') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pricing" id="pricing" value="1" {{ $employee->pricing || old('pricing', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('billing') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="billing" id="billing" value="1" {{ $employee->billing || old('billing', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('administrator') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="administrator" id="administrator" value="1" {{ $employee->administrator || old('administrator', 0) === 1 ? 'checked' : '' }}>
