    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.parts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity_price_break') ? 'is-invalid' : '' }}" type="text" name="quantity_price_break" id="quantity_price_break" value="{{ old('quantity_price_break', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minimum_line_charge') ? 'is-invalid' : '' }}" type="number" name="minimum_line_charge" id="minimum_line_charge" value="{{ old('minimum_line_charge', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quote') ? 'is-invalid' : '' }}" type="number" name="quote" id="quote" value="{{ old('quote', '') }}" step="1">
                @if($errors->has('quote'))
                    <div class="invalid-feedback">
                        {{ $errors->first('quote') }}
                    </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('bake') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="bake" id="bake" value="1" {{ old('bake', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('procedure_code') ? 'is-invalid' : '' }}" type="text" name="procedure_code" id="procedure_code" value="{{ old('procedure_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('material_condition') ? 'is-invalid' : '' }}" type="text" name="material_condition" id="material_condition" value="{{ old('material_condition', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thickness_minimum') ? 'is-invalid' : '' }}" type="number" name="thickness_minimum" id="thickness_minimum" value="{{ old('thickness_minimum', '') }}" step="0.000001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thickness_maximum') ? 'is-invalid' : '' }}" type="number" name="thickness_maximum" id="thickness_maximum" value="{{ old('thickness_maximum', '') }}" step="0.000001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thickness_unit_code') ? 'is-invalid' : '' }}" type="text" name="thickness_unit_code" id="thickness_unit_code" value="{{ old('thickness_unit_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('surface_area') ? 'is-invalid' : '' }}" type="number" name="surface_area" id="surface_area" value="{{ old('surface_area', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('surface_area_unit_code') ? 'is-invalid' : '' }}" type="text" name="surface_area_unit_code" id="surface_area_unit_code" value="{{ old('surface_area_unit_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight_unit_code') ? 'is-invalid' : '' }}" type="text" name="weight_unit_code" id="weight_unit_code" value="{{ old('weight_unit_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dimension_unit_code') ? 'is-invalid' : '' }}" type="text" name="dimension_unit_code" id="dimension_unit_code" value="{{ old('dimension_unit_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('material_thickness') ? 'is-invalid' : '' }}" type="number" name="material_thickness" id="material_thickness" value="{{ old('material_thickness', '') }}" step="0.0001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('material_thickness_unit_code') ? 'is-invalid' : '' }}" type="text" name="material_thickness_unit_code" id="material_thickness_unit_code" value="{{ old('material_thickness_unit_code', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('special_requirement') ? 'is-invalid' : '' }}" name="special_requirement" id="special_requirement">{{ old('special_requirement') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('operator_note') ? 'is-invalid' : '' }}" name="operator_note" id="operator_note">{{ old('operator_note') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quality_check_1') ? 'is-invalid' : '' }}" type="number" name="quality_check_1" id="quality_check_1" value="{{ old('quality_check_1', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quality_check_2') ? 'is-invalid' : '' }}" type="number" name="quality_check_2" id="quality_check_2" value="{{ old('quality_check_2', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quality_check_3') ? 'is-invalid' : '' }}" type="number" name="quality_check_3" id="quality_check_3" value="{{ old('quality_check_3', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quality_check_4') ? 'is-invalid' : '' }}" type="number" name="quality_check_4" id="quality_check_4" value="{{ old('quality_check_4', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quality_check_5') ? 'is-invalid' : '' }}" type="number" name="quality_check_5" id="quality_check_5" value="{{ old('quality_check_5', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quality_check_6') ? 'is-invalid' : '' }}" type="number" name="quality_check_6" id="quality_check_6" value="{{ old('quality_check_6', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_count') ? 'is-invalid' : '' }}" type="number" name="image_count" id="image_count" value="{{ old('image_count', '') }}" step="1">
