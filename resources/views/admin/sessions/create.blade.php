    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sessions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jwt') ? 'is-invalid' : '' }}" type="text" name="jwt" id="jwt" value="{{ old('jwt', '') }}">
                @if($errors->has('jwt'))
                    <div class="invalid-feedback">
                        {{ $errors->first('jwt') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('key_strokes') ? 'is-invalid' : '' }}" type="text" name="key_strokes" id="key_strokes" value="{{ old('key_strokes', '') }}">
